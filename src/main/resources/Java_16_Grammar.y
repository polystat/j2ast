...
// Token preferences
/*
%left  EQUAL STAR_EQUAL SLASH_EQUAL PERCENT_EQUAL PLUS_EQUAL MINUS_EQUAL
       GR_GR_EQUAL LESS_LESS_EQUAL THROW AMP_EQUAL CARET_EQUAL VERTICAL_EQUAL
%left  QUESTION
%left  DBL_VERTICAL
%left  DBL_AMPERSAND
%left  VERTICAL
%left  CARET
%left  AMPERSAND
%left  DBL_EQUAL NON_EQUAL
%left  LESS GREATER LESS_EQUAL GREATER_EQUAL
%left  DBL_LESS DBL_GREATER
%left  PLUS MINUS
%left  STAR SLASH PERCENT
%left  ARROW DOT
%left  EXCLAMATION TILDE
%left  DBL_PLUS DBL_MINUS
%left  LBRACKET RBRACKET
%left  COLON SEMICOLON ELSE
%left  STATIC CHAR BOOLEAN SHORT INT LONG FLOAT DOUBLE VOID CLASS
       ENUM IDENTIFIER INTERFACE
%left  LBRACE
*/
